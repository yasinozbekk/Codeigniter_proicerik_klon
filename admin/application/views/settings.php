						...
						<div class="card-body">
												...
												<div class="table-responsive">
													<table class="table align-middle mb-0 table-hover">
														...
														<tbody id="sortable" data-url="<?php echo base_url("admin/socialmedia/ranksetter"); ?>">
																				...
																				<tr id="rank-<?php echo $socialmedia->socialmedia_id ?>">
																					...
																					<td>
																						...
																						<div class="form-check form-switch">
																							<input class="form-check-input" type="checkbox" data-url="<?php echo base_url("admin/socialmedia/isactivesetter/$socialmedia->socialmedia_id") ?>" id="isActive" <?php echo $socialmedia->socialmedia_status == 1 ? "checked" : "" ?>>
																						</div>
																					</td>
																					<td>
																						<div class="d-flex order-actions">	
																							...
																							<a class="ms-4 deleteSocialMedia" data-id="<?php echo $socialmedia->socialmedia_id ?>" data-url="<?php echo base_url("admin/socialmedia/accountDelete/$socialmedia->socialmedia_id") ?>"><i class="bx bx-trash"></i></a>
																						</div>
																					</td>
																				</tr>
