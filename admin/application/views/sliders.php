							...
							<div class="card-body">
												...
												<div class="table-responsive">
													<table class="table align-middle mb-0 table-hover">
														...
														<tbody id="sortable" data-url="<?php echo base_url("admin/sliders/ranksetter"); ?>">
																				...
																				<tr id="rank-<?php echo $sliders->sliders_id ?>">
																					...
																					<td>
																						...
																						<div class="form-check form-switch">
																							<input class="form-check-input" type="checkbox" data-url="<?php echo base_url("admin/sliders/statusupdate/$sliders->sliders_id") ?>" id="isActive" <?php echo $sliders->sliders_status == 1 ? "checked" : "" ?>>
																						</div>
																					</td>
																					<td>
																						<div class="d-flex order-actions">	
																							...
																							<a class="ms-4 deletesliders" data-id="<?php echo $sliders->sliders_id ?>" data-url="<?php echo base_url("admin/sliders/delete/$sliders->sliders_id") ?>"><i class="bx bx-trash"></i></a>
																						</div>
																					</td>
																				</tr>
